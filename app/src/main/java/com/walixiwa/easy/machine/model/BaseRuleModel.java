...
public class BaseRuleModel implements Serializable {
    private String name;//引擎名称，后续更新站源不得修改
    private String version;//引擎版本
    private String reqCharset;//请求编码，默认为UTF-8
    private String htmlCharset;//返回编码，默认为UTF-8
    private String userAgent;//浏览器UA，默认为手机UA
    ...
    private String ruleResultCoverHeader;//搜索结果图片前缀，APP暂未用到此字段
    private String ruleResultCover;//搜索结果图片前缀，APP暂未用到此字段 <子匹配>
    ...
    private String ruleResultType;//类型，非强制，可以为其他信息 <子匹配>
    private String ruleResultTime;//时间，非强制，可以为其他信息 <子匹配>
    ...
    private String ruleSniffPattern;//嗅探目标规则，用于匹配播放地址，详见DEMO
    private String ruleDetailMain;//链接&标题 <整个匹配>
    private String ruleDetailTitle;//链接规则 <子匹配>
    private String ruleDetailLinkHeader;//播放链接前缀，用于补充播放链接 可以留空 <子匹配>
    private String ruleDetailLink;//播放链接规则 <子匹配>
